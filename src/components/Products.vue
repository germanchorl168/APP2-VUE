...
<template>
    ...
    <div class="cards-columns " >
        <div class="card" style="width: 18rem;" v-for="(producto,i) in productos" :key="i">
            ...
            <div class="card-body" >
                ...
                <div v-if="mostrar">
                    ...
                    <button v-on:click="mostrar =!mostrar" class="btn btn-outline-primary btn-block">Ver más</button>
                </div>
            </div>
        </div>
